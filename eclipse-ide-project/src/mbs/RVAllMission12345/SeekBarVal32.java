...
//     mItemAsli = menu.add("Asli"); 
	...
	public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        Imgproc.putText(mRgba, "nLUX2:   " + nLux2, new Point ( 350, 85), Core.FONT_HERSHEY_SIMPLEX, 0.4, new Scalar(0, 0, 255), 1);
		   ...
		   Imgproc.putText(mRgba, "Merah", new Point (mRgba.cols() / 2, mRgba.rows() * 0.15), Core.FONT_HERSHEY_SIMPLEX, 0.7, new Scalar(0, 0, 255), 2);
...
//	            mSpectrum.copyTo(spectrumLabel);
				...
				Imgproc.putText(mRgba, "HSV 4", new Point (380, 210), Core.FONT_HERSHEY_SIMPLEX, 1, new Scalar(0, 0, 255), 2);
