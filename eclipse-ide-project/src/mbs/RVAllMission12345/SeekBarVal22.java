...
//			if (mIsColorSelected) {
				...
				Button bHor = (Button)findViewById(R.id.tombolHor);
				...
				seekHorMin=(SeekBar) findViewById(R.id.min);
				seekHorMax=(SeekBar) findViewById(R.id.max);
				...
				bHor.setOnClickListener(new View.OnClickListener(){
					@Override
					public void onClick(View v) {
						// TODO Auto-generated method stub
...
//	            mSpectrum.copyTo(spectrumLabel);
		        ...
		        Imgproc.line(mRgba, new Point(0, batHorzonB), new Point(480, batHorzonB), new Scalar( 255, 0, 255 ), 1, 8 ,0 );
				Imgproc.putText(mRgba, "G "+ SeekBarVal23.TGate , new Point (0, batHorzonB-SeekBarVal23.TGate), Core.FONT_HERSHEY_SIMPLEX, 0.4, new Scalar(0, 0, 255), 1);
				...
				Imgproc.putText(mRgba, "HSV 2", new Point (380, 210), Core.FONT_HERSHEY_SIMPLEX, 1, new Scalar(0, 0, 255), 2);
