...
public class Imgproc {
    ...
    //
    // C++:  Mat cv::getImuRotationMatrix2D(Point2f center, double angle, double scale)
    //

    //javadoc: getImuRotationMatrix2D(center, angle, scale)
    public static Mat getImuRotationMatrix2D(Point center, double angle, double scale)
    {
        
        Mat retVal = new Mat(getImuRotationMatrix2D_0(center.x, center.y, angle, scale));
...
public static Size getTextSize(String text, int fontFace, double fontScale, int thickness, int[] baseLine) {
    ...
    // C++:  Mat cv::getImuRotationMatrix2D(Point2f center, double angle, double scale)
    private static native long getImuRotationMatrix2D_0(double center_x, double center_y, double angle, double scale);
