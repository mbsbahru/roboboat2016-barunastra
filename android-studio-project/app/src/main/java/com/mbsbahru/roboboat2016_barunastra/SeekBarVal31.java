...
public class SeekBarVal31 extends Activity implements OnTouchListener, CvCameraViewListener2 {
	private static final String TAG = "SeekActivity";
	//   private static final int    VIEW_MODE_ASLI   = 0;
	private static final int    VIEW_MODE_HSV31   = 0;
	private static final int    VIEW_MODE_HSV32   = 2;
	private static final int    VIEW_MODE_HSV33   = 3;
	private static final int    VIEW_MODE_HSV34   = 4;
	...
	private Mat mRgba;
	private Mat mHSV;
	public static int Hmin = 80;
	public static int Hmax = 90;
	public static int Smin = 181;
	public static int Smax = 260;
	public static int Vmin = 79;
	public static int Vmax = 259;
...
//		           Log.i(TAG, "OpenCV loaded successfully");  
					...
					mOpenCvCameraView.setOnTouchListener(SeekBarVal31.this);
				} break;
				default:
				{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.biner31);
...
//		mItemExposure = menu.add("exp");
	...
	public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
		...
		Imgproc.putText(mRgba, "Hijau", new Point (mRgba.cols() / 2, mRgba.rows() * 0.15), Imgproc.FONT_HERSHEY_SIMPLEX, 0.7, new Scalar(0, 0, 255), 2);

//		if (viewMode==VIEW_MODE_ASLI)return mRgba;
		if (viewMode==VIEW_MODE_HSV32){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal31.this, SeekBarVal32.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_HSV33){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal31.this, SeekBarVal33.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_HSV34){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal31.this, SeekBarVal34.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_HSV11){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal31.this, SeekBarVal11.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_HSV21){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal31.this, SeekBarVal21.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_BALIK){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal31.this, BluetoothConf.class);
			startActivity(intent);
			finish();
		}
