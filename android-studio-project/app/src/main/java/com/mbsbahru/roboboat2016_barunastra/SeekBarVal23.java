...
//			if (mIsColorSelected) {
			...
			Button bTBol = findViewById(R.id.tombolHeight);
			...
			seekHmin3= findViewById(R.id.min);
			seekHmax3= findViewById(R.id.max);
			seekSmin3= findViewById(R.id.min);
			seekSmax3= findViewById(R.id.max);
			seekVmin3= findViewById(R.id.min);
			seekVmax3= findViewById(R.id.max);
			seekErode3= findViewById(R.id.min);
			seekDilate3= findViewById(R.id.max);
			seekBolGate= findViewById(R.id.min);
			seekBolObs= findViewById(R.id.max);
...
//	            Imgproc.drawContours(mRgba, contours, -1, new Scalar((mBlobColorRgba.val[0]+63>255)?mBlobColorRgba.val[0]-63:mBlobColorRgba.val[0]+63, (mBlobColorRgba.val[1]+63>255)?mBlobColorRgba.val[1]-63:mBlobColorRgba.val[1]+63, (mBlobColorRgba.val[2]+63>255)?mBlobColorRgba.val[2]-63:mBlobColorRgba.val[2]+63), 5);
				...
				Imgproc.putText(mRgba, "valBot:   " + Hmin3 + ",  " + Smin3 + ",  " + Vmin3 + ",  " + Erode3, new Point (mRgba.cols() / 8, mRgba.rows() * 0.05), Imgproc.FONT_HERSHEY_SIMPLEX, 0.4, new Scalar(0, 255, 0), 1);
				Imgproc.putText(mRgba, "valMax:   " + Hmax3 + ",  " + Smax3 + ",  " + Vmax3 + ",  " + Dilate3, new Point (mRgba.cols() / 8, mRgba.rows() * 0.1), Imgproc.FONT_HERSHEY_SIMPLEX, 0.4, new Scalar(0, 255, 0), 1);
...
//	            mSpectrum.copyTo(spectrumLabel);
			...
			Imgproc.putText(mRgba, "HSV 3", new Point (380, 210), Imgproc.FONT_HERSHEY_SIMPLEX, 1, new Scalar(0, 0, 255), 2);
			Imgproc.putText(mRgba, "Exp:  " + val, new Point (5,210), Imgproc.FONT_HERSHEY_SIMPLEX, 0.4, new Scalar(0, 0, 255), 1);
			Imgproc.putText(mRgba, "TingGat: " + TGate, new Point (5, 200), Imgproc.FONT_HERSHEY_SIMPLEX, 0.5, new Scalar(0, 0, 255), 1);
			Imgproc.putText(mRgba, "TingObs: " + TObs, new Point (5, 190), Imgproc.FONT_HERSHEY_SIMPLEX, 0.5, new Scalar(0, 0, 255), 1);
			...
			Imgproc.line(mRgba, new Point(0, SeekBarVal22.batHorzonB), new Point(480, SeekBarVal22.batHorzonB), new Scalar( 255, 0, 255 ), 1, 8 ,0 );
			Imgproc.putText(mRgba, "G "+ TGate , new Point (0, SeekBarVal22.batHorzonB -TGate), Imgproc.FONT_HERSHEY_SIMPLEX, 0.4, new Scalar(0, 0, 255), 1);
			Imgproc.putText(mRgba, " "+ (SeekBarVal22.batHorzonB-SeekBarVal22.batHorzonA) , new Point (0, (SeekBarVal22.batHorzonB+SeekBarVal22.batHorzonA)/2), Imgproc.FONT_HERSHEY_SIMPLEX, 0.4, new Scalar(0, 0, 255), 1);
			Imgproc.putText(mRgba, " "+ SeekBarVal22.batHorzonA, new Point (0, SeekBarVal22.batHorzonA), Imgproc.FONT_HERSHEY_SIMPLEX, 0.4, new Scalar(0, 0, 255), 1);
			Imgproc.putText(mRgba, " " + SeekBarVal22.batHorzonB, new Point (0, SeekBarVal22.batHorzonB), Imgproc.FONT_HERSHEY_SIMPLEX, 0.4, new Scalar(0, 0, 255), 1);
