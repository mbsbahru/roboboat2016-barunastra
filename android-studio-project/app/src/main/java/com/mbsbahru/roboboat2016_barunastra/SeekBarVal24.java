...
public class SeekBarVal24 extends Activity implements OnTouchListener, CvCameraViewListener2 {
	...
	private static final int    VIEW_MODE_HSV23   = 3;
	private static final int    VIEW_MODE_HSV24   = 0;
...
//   private MenuItem     mItemAsli;
	...
	private Mat mRgba;
	private Mat mHSV;
	public static int Hmin = 39;
	public static int Hmax = 60;
	public static int Smin = 159;
	public static int Smax = 257;
	public static int Vmin = 155;
...
//		           Log.i(TAG, "OpenCV loaded successfully");  
					...
					mOpenCvCameraView.setOnTouchListener(SeekBarVal24.this);
				} break;
				default:
				{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.biner24);
...
//		if (viewMode==VIEW_MODE_ASLI)return mRgba;
		if (viewMode==VIEW_MODE_HSV21){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal24.this, SeekBarVal21.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_HSV22){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal24.this, SeekBarVal22.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_HSV23){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal24.this, SeekBarVal23.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_HSV25){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal24.this, SeekBarVal25.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_HSV11){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal24.this, SeekBarVal11.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_BALIK){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal24.this, BluetoothConf.class);
			startActivity(intent);
			finish();
		}
