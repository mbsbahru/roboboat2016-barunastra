...
public class SeekBarVal34 extends Activity implements OnTouchListener, CvCameraViewListener2 {
	...
	private static final int    VIEW_MODE_HSV33   = 3;
	private static final int    VIEW_MODE_HSV34   = 0;
	private static final int    VIEW_MODE_HSV41   = 7;
	...
	private Mat mRgba;
	private Mat mHSV;
	public static int Hmin = 79;
	public static int Hmax = 86;
	public static int Smin = 251;
	public static int Smax = 257;
	public static int Vmin = 0;
	public static int Vmax = 13;
	public static int Dilate = 1;
	public static int Erode = 1;
	public static int minT = 255;
	public static int maxT = 260;
	//   public static int minT = 0;
//   public static int maxT = 50;
	private Mat mGray;
...
//		           Log.i(TAG, "OpenCV loaded successfully");  
					...
					mOpenCvCameraView.setOnTouchListener(SeekBarVal34.this);
				} break;
				default:
				{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.biner34);
...
//		mItemExposure = menu.add("exp");
	...
	public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
		...
		Imgproc.putText(mRgba, "Hitam", new Point (mRgba.cols() / 2, mRgba.rows() * 0.15), Imgproc.FONT_HERSHEY_SIMPLEX, 0.7, new Scalar(0, 0, 255), 2);

//		if (viewMode==VIEW_MODE_ASLI)return mRgba;
		if (viewMode==VIEW_MODE_HSV31){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal34.this, SeekBarVal31.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_HSV32){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal34.this, SeekBarVal32.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_HSV33){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal34.this, SeekBarVal33.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_HSV41){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal34.this, SeekBarVal41.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_HSV21){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal34.this, SeekBarVal21.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_HSV11){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal34.this, SeekBarVal11.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_BALIK){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal34.this, BluetoothConf.class);
			startActivity(intent);
			finish();
		}
...
//					Imgproc.Canny(mBiner, mBiner, 0, 260);
