...
public class SeekBarVal32 extends Activity implements OnTouchListener, CvCameraViewListener2 {
	...
	private static final int    VIEW_MODE_HSV32   = 0;
	private static final int    VIEW_MODE_HSV33   = 3;
	private static final int    VIEW_MODE_HSV34   = 2;
...
//   private MenuItem     mItemAsli;
	...
	public static int Hmax = 18;
	public static int Smin = 69;
	public static int Smax = 260;
	public static int Vmin = 13;
...
//		           Log.i(TAG, "OpenCV loaded successfully");  
					...
					mOpenCvCameraView.setOnTouchListener(SeekBarVal32.this);
				} break;
				default:
				{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.biner32);
...
//		mItemExposure = menu.add("exp");
	...
	public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
		...
		Imgproc.putText(mRgba, "Merah", new Point (mRgba.cols() / 2, mRgba.rows() * 0.15), Imgproc.FONT_HERSHEY_SIMPLEX, 0.7, new Scalar(0, 0, 255), 2);

//		if (viewMode==VIEW_MODE_ASLI)return mRgba;
		if (viewMode==VIEW_MODE_HSV31){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal32.this, SeekBarVal31.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_HSV33){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal32.this, SeekBarVal33.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_HSV34){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal32.this, SeekBarVal34.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_HSV21){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal32.this, SeekBarVal21.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_HSV11){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal32.this, SeekBarVal11.class);
			startActivity(intent);
			finish();
		}
		else if (viewMode==VIEW_MODE_BALIK){
			onCameraViewStopped();
			Intent intent = new Intent(SeekBarVal32.this, BluetoothConf.class);
			startActivity(intent);
			finish();
		}
...
//	            mSpectrum.copyTo(spectrumLabel);
			...
			Imgproc.putText(mRgba, "HSV 4", new Point (380, 210), Imgproc.FONT_HERSHEY_SIMPLEX, 1, new Scalar(0, 0, 255), 2);
